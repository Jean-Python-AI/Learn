...
Ce projet entraîne « à la main » un [[AI/Architecures/1 MLP/0 Index|MLP]], avec NumPy et sans framework de réseau de neurones, à reconnaître les chiffres manuscrits de **0 à 9**.
...
La sigmoïde transforme chaque valeur en un nombre compris entre 0 et 1. Voir [[AI/Architecures/0 Perceptron/A(Z)|la fonction d'activation]], [[AI/Architecures/1 MLP/Forward Propagation|la propagation avant]] et [[AI/Architecures/1 MLP/Vectorisation|la vectorisation]].
...
La loss est faible lorsque la sortie du bon chiffre est proche de 1 et que les autres sont proches de 0. Voir [[AI/Architecures/0 Perceptron/Log Loss|Log Loss]].
...
Pendant la propagation avant, le réseau mémorise $A^{[c]}$ et $Z^{[c]}$. Il remonte ensuite l'erreur de la dernière couche vers la première : c'est la [[AI/Architecures/1 MLP/Back-Propagation|backpropagation]].
...
avec $\alpha=0{,}01$ dans le code. Voir aussi [[AI/Architecures/0 Perceptron/Descante de gradients|la descente de gradient]] et [[AI/Architecures/1 MLP/Entrainement du réseau|l'entraînement du réseau]].
